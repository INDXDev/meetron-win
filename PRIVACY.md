...
Meeting Copilot runs locally, but the audio bridge sends meeting audio to ChatGPT Web Voice and sends ChatGPT Voice output into the selected meeting. Those services process audio under the user's account settings, terms, and privacy policies.
...
Before connecting Meeting Copilot:
